            ...
            <body style="font-family:sans-serif;padding:40px;text-align:center;background:#111;color:white;">
              ...
              <form method="GET" action="/api/qr/${token}">
                <input name="password" type="password"
                  ...
                  style="padding:10px;font-size:16px;border-radius:8px;border:none;margin:10px;" />
                <br/>
                <button type="submit"
                  style="padding:10px 30px;background:#22c55e;color:white;
        ...
        return res.send(`
          <html>
            <body style="font-family:sans-serif;padding:40px;text-align:center;background:#111;color:white;">
              ...
              <a href="/api/qr/${token}" style="color:#22c55e;">Try Again</a>
            </body>
          </html>
        `);
      }
